...
const UsersIcon = (p: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...p}>
    <circle cx="9" cy="8" r="3"/><path d="M2 20a7 7 0 0114 0"/><circle cx="17" cy="10" r="2"/><path d="M22 20a5 5 0 00-7-4"/>
  </svg>
);
const OrgIcon = (p: any) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...p}>
    <rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/>
    <rect x="8.5" y="14" width="7" height="7" rx="1"/><path d="M6.5 10v4M17.5 10v4M12 14V10" />
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-white text-slate-900">
      <div className="mx-auto flex max-w-[1400px]">
        <aside
          className={[
            'sticky top-0 hidden h-[100dvh] border-r border-slate-200 bg-white md:flex md:flex-col',
            collapsed ? 'w-16' : 'w-72',
          ].join(' ')}
        >
          <div className="flex items-center justify-between p-3">
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-brand-600 text-white">AD</div>
